    ...
    <>
      ...
      <div className="flex flex-col items-start pt-8 text-left max-w-md m-auto">
        ...
        <div className="my-5">
          ...
          between client and server. Javascript has afforded us this ability,
          but we must wield the power responsibly.
        </div>

        <h4 className="mt-5 text-md font-semibold">No Magic</h4>
        <div className="my-5 text-sm leading-6">
          Nothing is abstracted away. This is a pattern for building web
          clients. There is no library, SDK, framework or anything more than a
          starting point. You can use it as a reference or a head start on your
          next project.
        </div>
        ...
        <div className="my-5 text-sm leading-6">
          Routes are entirely flexible. You don't have to prefix a backend
          request with <pre className="inline-block">/api</pre>, unless of
          course you want to. If Hono matches a route, say to{" "}
          <pre className="inline">/auth</pre> it will handle it on the server.
          If it doesn't match, it will delegate to the "view" router. That
          router is Tanstack's relatively new but full featured and production
          ready router. This example uses a new but familiar{" "}
        ...
        <div className="my-5 text-sm leading-6">
          ...
          frameworks like Remix, Astro, Modern and more have elected to move
        ...
        <div className="my-5 text-sm leading-6">
          ...
          <br />
          <br />
          That said, it would be nice to have a loader server hook method
          binding that could allow us to return different status codes or even
          redirect at the server, but this is a discussion for another day.
        </div>
        ...
        <div className="my-5 text-sm leading-6">
          ...
          <br />
          <br />
          To do this without manually adding context into our renderer service
          we create one new abstraction -- a "state module". State modules have
          a registry the renderer service will read, then pass the data through
